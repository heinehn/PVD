...
ax.plot(time,inputSensor_2[:,2], label = r'Sensor 2', color = 'r')
#ax.plot(time,inputSensor_3[:,2], label = r'Sensor 3', color = 'gray')
ax.plot(time,inputSensor_4[:,2], label = r'Sensor 4', color = 'b')
xlabel(r'Process time,[s]', size = 20,labelpad= 5 )
ylabel(r'Frequency, [Hz]',size = 20, labelpad = 5)
title( r'Sensor frequency vs time: ' + fileName )
legend(loc='smart')
...
title( r'Deposition rate vs time: ' + fileName )
bx.legend(loc='smart')
bx.set_ylim(-0.1,)
bx2.set_ylim(0,50)
